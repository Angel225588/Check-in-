...
describe("VIP - Extraction validation", () => {
  ...
  it("handles multiple VIP levels from the report (X4, P6, etc.)", () => {
    const entries: VipEntry[] = [
      { roomNumber: "151", name: "RECKER", vipLevel: "X4", vipNotes: "", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
      { roomNumber: "209", name: "SIDDIAH", vipLevel: "P6", vipNotes: "", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
      { roomNumber: "409", name: "SI YONGLE", vipLevel: "P6", vipNotes: "", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
    ];
...
describe("VIP - Merge with existing client list", () => {
  const baseClients: Client[] = [
    {
      ...
      adults: 2, children: 0, rateCode: "RACK", packageCode: "BKF GRP",
    },
    {
      roomNumber: "222", 
      name: "JEN JASON HAO WEI", arrivalDate: "03/03/26", departureDate: "10/03/26",
      adults: 2, children: 0, rateCode: "BAR", packageCode: "",
    },
    {
      roomNumber: "500", 
  ...
  const vipEntries: VipEntry[] = [
    {
      ...
      vipNotes: "Member Rate (M5)", 
      arrivalDate: "06/03/26", departureDate: "10/03/26", 
    ...
    },
    {
      ...
      arrivalDate: "03/03/26",
      departureDate: "10/03/26", adults: 2, children: 0, rateCode: "",
    },
    {
      roomNumber: "308", name: "ZAMANI REZA ADRIAN", vipLevel: "X4",
      vipNotes: "High Floor Room (H1)", 
      arrivalDate: "03/03/26", departureDate: "07/03/26", 
  ...
  it("handles multiple VIPs matching same room+name (last wins)", () => {
    const dupeVips: VipEntry[] = [
      { roomNumber: "151", name: "RECKER DAVID LEE", vipLevel: "X4", vipNotes: "Note A", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
      { roomNumber: "151", name: "RECKER DAVID LEE", vipLevel: "P6", vipNotes: "Note B", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
    ];
  ...
  it("keeps separate clients in same room as separate entries", () => {
    ...
    const vip: VipEntry[] = [
      { roomNumber: "101", name: "GUEST ALPHA", vipLevel: "X4", vipNotes: "", arrivalDate: "", departureDate: "", adults: 0, children: 0, rateCode: "" },
    ];
  ...
  it("adds VIP as new entry when room matches but name differs (shared room)", () => {
    ...
    const vip: VipEntry[] = [
      { roomNumber: "101", name: "DIFFERENT VIP GUEST", vipLevel: "P6", vipNotes: "High Floor", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "" },
    ];
...
describe("VIP - Deduplication (multi-photo)", () => {
  it("deduplicates by room+name, keeping last occurrence", () => {
    const clients: Client[] = [
      { roomNumber: "101", name: "Guest One", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "", packageCode: "" },
      { roomNumber: "102", name: "Guest Two", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "", packageCode: "" },
      { roomNumber: "101", name: "Guest One", arrivalDate: "", departureDate: "", adults: 2, children: 0, rateCode: "", packageCode: "" },
    ];
  ...
  it("keeps different clients in same room as separate", () => {
    const clients: Client[] = [
      { roomNumber: "101", name: "ALPHA GUEST", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "", packageCode: "" },
      { roomNumber: "101", name: "BETA GUEST", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "", packageCode: "" },
    ];
    const result = deduplicateClients(clients);
    expect(result).toHaveLength(2);
  });
  ...
  it("combines and deduplicates multiple batches", () => {
    ...
    const batch2: Client[] = [
      { roomNumber: "102", name: "Guest Two", arrivalDate: "", departureDate: "", adults: 1, children: 0, rateCode: "", packageCode: "" },
      { roomNumber: "201", name: "Guest Three", arrivalDate: "", departureDate: "", adults: 2, children: 0, rateCode: "", packageCode: "" },
    ];
