...
const translations = {
  ...
  "upload.compChildren": { fr: "+{n} enfant(s) en chambre COMP — le rapport ne compte que les adultes.", en: "+{n} child(ren) in COMP rooms — the report counts adults only." },
  "upload.reportTotals": { fr: "Total du rapport", en: "Report totals" },
  "upload.compDrift": { fr: "COMP adultes: le rapport indique {printed} — nous en comptons {counted}. Le rapport fait foi.", en: "COMP adults: the report says {printed} — we counted {counted}. The report is authoritative." },
  ...
  "search.comp": { fr: "Compliment", en: "Compliment" },
  ...
  "report.paymentMixOffList": { fr: "Mode de paiement (hors liste)", en: "Payment mode (off-list)" },
  ...
  "dash.compCost": { fr: "Coût Compliments", en: "Compliments Cost" },
  ...
  "report.compRooms": { fr: "Chambres Compliment", en: "Compliment Rooms" },
  ...
  "dash.monthlyStats": { fr: "Bilan Pilote", en: "Pilot Stats" },
  "dash.monthlyStatsHint": { fr: "Données auto-extraites pour le mail de proposition", en: "Auto-extracted data for the proposal email" },
  "dash.copyStats": { fr: "Copier résumé", en: "Copy summary" },
  "dash.statsCopied": { fr: "Copié !", en: "Copied!" },
  "dash.daysActive": { fr: "Jours actifs", en: "Active days" },
  "dash.attendance": { fr: "Assistance", en: "Attendance" },
  "dash.served": { fr: "Servis", en: "Served" },
  "dash.compCostShort": { fr: "Coût compl.", en: "Compl. cost" },
