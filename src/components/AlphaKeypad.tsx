...
export default function AlphaKeypad({
  ...
  const key =
    "glass-key rounded-xl flex-1 min-w-0 min-h-[clamp(46px,8vh,72px)] text-xl md:text-2xl font-bold active:scale-95 transition-transform select-none";

  return (
    <div
      className="glass-surface rounded-[14px] p-2 md:p-3 flex flex-col gap-2 w-full"
      role="group"
    ...
    >
      ...
      <div className="flex gap-2">
        <button
          {...press(onToggleMode)}
          data-role="pad-123"
          className="flex-[2] min-w-0 bg-teal/90 text-white rounded-xl min-h-[clamp(46px,8vh,72px)] text-base font-bold active:scale-95 transition-transform select-none"
        >
          123
        </button>
        <button
        ...
        <button
          ...
          className="flex-[2] min-w-0 bg-slate/90 text-white rounded-xl min-h-[clamp(46px,8vh,72px)] active:scale-95 transition-transform select-none"
        >
